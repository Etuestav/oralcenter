        ...
        <div class="col-md-12">
          <div class="box box-info">
                   ...
                   <ol class="breadcrumb">
                      ...
                      <li><a href="<?= base_url('concepto') ?>"><i class="fa fa-hand-o-left"></i> Volver</a></li>
          ...
          <div class="box-body pad">
              ...
              <form id="FormRegistrarConcepto" action="<?php echo base_url();?>concepto/guardar" method="POST" autocomplete="off">
