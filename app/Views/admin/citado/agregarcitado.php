      ...
      <div class="col-md-12">
        <div class="box box-info">
                 ...
                 <ol class="breadcrumb">
                    ...
                    <li><a href="<?= base_url('citado') ?>"><i class="fa fa-hand-o-left"></i> Volver</a></li>
        ...
        <div class="box-body pad">
            ...
            <form id="FormRegistrarCitado" action="<?php echo base_url('');?>citado/guardar" method="POST" autocomplete="off">
          ...
          <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group <?php echo !empty(form_error('nombre'))? 'has-error':'';?>">
                    ...
                    <input type="text" name="nombre" class="form-control input-sm" placeholder="Descripción">
                  </div>
                </div>
