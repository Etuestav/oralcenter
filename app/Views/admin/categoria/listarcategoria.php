...
<div id="content" class="content-wrapper-2">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-th-list" aria-hidden="true"></i> Categoría
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
                   ...
                   <ol class="breadcrumb">
                      <li><a href="<?= base_url('categoria') ?>"><i class="fa fa-refresh"></i> Actualizar</a></li>
                      <li><a href="<?= base_url('categoria/nuevo') ?>"><i class="fa fa-user-plus"></i> Nuevo</a></li>
              ...
              <form id="CategoriaFormBusqueda" autocomplete="off">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label">Búsqueda por categoría :</label>
